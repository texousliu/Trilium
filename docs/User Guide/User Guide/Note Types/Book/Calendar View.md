...
|     |     |     |
| --- | --- | --- |  
| 1   | ![](19_Calendar View_image.png) | The Calendar View works only for Book note types. To create a new note, right click on the note tree on the left and select Insert note after, or Insert child note and then select _Book_. |
| 2   | ![](10_Calendar View_image.png) | Once created, the “View type” of the Book needs changed to “Calendar”, by selecting the “Book Properties” tab in the ribbon. |
...
![](16_Calendar View_image.png)The calendar displays all the child notes of the book that have a `#startDate`. An `#endDate` can optionally be added.
...
|     |     |
| --- | --- |
| ![](Calendar View_image.png) | ![](1_Calendar View_image.png) |
...
|     |     |
| --- | --- |
| ![](5_Calendar View_image.png) | ![](3_Calendar View_image.png) |
...
|     |     |
| --- | --- |
| ![](6_Calendar View_image.png) | ![](7_Calendar View_image.png) |