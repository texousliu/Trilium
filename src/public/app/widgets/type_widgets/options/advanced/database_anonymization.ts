...
<div class="options-section">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <button class="anonymize-full-button btn btn-primary">${t("database_anonymization.save_fully_anonymized_database")}</button>
        </div>
        ...
        <div class="col-md-6">
            ...
            <button class="anonymize-light-button btn btn-primary">${t("database_anonymization.save_lightly_anonymized_database")}</button>
        </div>
    </div>
